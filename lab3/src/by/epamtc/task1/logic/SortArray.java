...
public class SortArray {
    ...
    public static void bubbleSort(IntegerArray array) throws EmptyArrayException {
    ...
    public static void insertSort(IntegerArray array) throws EmptyArrayException {
        int[] sortedArray = array.getValues();
        if (sortedArray == null) throw new EmptyArrayException("Array is not initialized");
    ...
    public static void selectSort(IntegerArray array) throws EmptyArrayException {
        int[] sortedArray = array.getValues();
        if (sortedArray == null) throw new EmptyArrayException("Array is not initialized");
