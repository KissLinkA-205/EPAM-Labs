...
public class FindingArrayElement {
    public static int binarySearch(IntegerArray array, int elementToSearch) throws EmptyArrayException {
    ...
    public static int findMinValue(IntegerArray array) throws EmptyArrayException {
        int[] workingArray = array.getValues();
        if (workingArray == null) throw new EmptyArrayException("Array is not initialized");
    ...
    public static int findMaxValue(IntegerArray array) throws EmptyArrayException{
        int[] workingArray = array.getValues();
        if (workingArray == null) throw new EmptyArrayException("Array is not initialized");
